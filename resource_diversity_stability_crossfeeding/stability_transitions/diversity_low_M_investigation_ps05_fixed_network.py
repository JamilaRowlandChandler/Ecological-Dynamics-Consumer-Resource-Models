...
if __name__ == '__main__':
    ...
    with open('diversity_low_M_investigation_ps05_fixed_network_results.pkl', 'wb') as f:
        pickle.dump(results, f)

    print("Saved results to diversity_low_M_investigation_ps05_fixed_network_results.pkl")
