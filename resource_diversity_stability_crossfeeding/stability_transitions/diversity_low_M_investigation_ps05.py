...
Same as diversity_low_M_investigation.py, but with p_s FIXED at 0.5 for
every M (instead of scaling as min(5/M,1)) - checking whether the humped
o-vs-diversity relationship (and its flip between single-source and
all-resources-supplied) depends on keeping the dominant resource's
out-degree roughly constant across M, or persists with a fixed link
probability instead.
"""
...
if __name__ == '__main__':
    ...
    with open('diversity_low_M_investigation_ps05_results.pkl', 'wb') as f:
        pickle.dump(results, f)

    print("Saved results to diversity_low_M_investigation_ps05_results.pkl")
