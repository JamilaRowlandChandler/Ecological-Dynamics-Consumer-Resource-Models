# -*- coding: utf-8 -*-
"""
Created on Mon Sep  7 12:21:08 2026
...
def compare_abiotic_biotic(stability_ab,
    ...
    def stability_plot(stability_pivot,
        ...
        ax.set_xlabel('heterogeneity in growth/consumption, ' + r'$\sigma$',
                      fontsize = 10, weight = 'bold')
    ...
    stability_plot(stability_ab,
                   feasibility_ab,
                   "Externally-supplied resources, " + r'$M = 500$',
                   axs)
...
simulations_abiotic, stability_abiotic = load_clean_simulations("rho_sigma_es_largeM")
