    ...
    def simulation(self,
        ...
        if not self.growth_saturation:
            ...
            def jacobian(t, y):
                ...
                applies identically to both, unlike the 'flux' variant which
                needed separate Gx/Gy (growth) and Sx/Sy (consumption)
                pieces.
            ...
            raise ValueError(
                ...
                "Expected one of 'flux', 'reversible', 'boltzmann'.")
